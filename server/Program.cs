...
app.MapDelete("/auth/delete-account", async (HttpRequest request) => 
{
    var dbManager = GetDBManager(request);
...
app.MapGet("/strings/get-all", (HttpRequest request) => 
{
    var dbManager = GetDBManager(request);
...
app.MapPost("/strings/search", async (HttpRequest request) => 
{
    ...
    try
    {
        var data = JsonSerializer.Deserialize<SearchRequest>(body, new JsonSerializerOptions 
        { 
            PropertyNameCaseInsensitive = true 
        });
...
app.MapDelete("/strings/delete", async (HttpRequest request) => 
{
    var dbManager = GetDBManager(request);
...
app.MapDelete("/strings/delete-all", (HttpRequest request) => 
{
    var dbManager = GetDBManager(request);
...
app.MapGet("/history/get", (HttpRequest request) => 
{
    var dbManager = GetDBManager(request);
